...
thumbUrl= thumbUrl.replace("_b.jpg","_s.jpg");thumbUrl= thumbUrl.replace("_m.jpg","_s.jpg");}
 ...
 try {
    ...
    if (feat_showPostDate == true) {
       ...
       (feat_showCommentCount == true) {
        if (flag == 1) {
            feat_myDiv.appendChild(document.createTextNode(" | "));
        }
        if (commentText == '1 Comments') commentText = '1 Comment';
        if (commentText == '0 Comments') commentText = 'Comments';
...
var feat_myLink = document.createElement('a');
  if(href.substring(href.length-17,href.length)=="#comment-form") {href= href.substring(0,href.length-17)+"?Full"+"#comment-form";feat_myLink.setAttribute("href", href);}
        else feat_myLink.setAttribute("href", href+"?Full");
